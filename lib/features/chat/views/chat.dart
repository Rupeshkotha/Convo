...
import 'package:Convo/features/chat/controllers/chat_controller.dart';
import 'package:Convo/features/chat/models/message.dart';
import 'package:Convo/features/chat/views/widgets/attachment_picker.dart';
import 'package:Convo/features/chat/views/widgets/chat_date.dart';
import 'package:Convo/features/chat/views/widgets/chat_field.dart';
import 'package:Convo/features/chat/views/widgets/chat_mic.dart';
import 'package:Convo/features/chat/views/widgets/message_cards.dart';
import 'package:Convo/features/chat/views/widgets/scroll_btn.dart';
import 'package:Convo/features/chat/views/widgets/voice_recorder.dart';
import 'package:Convo/shared/models/user.dart';
import 'package:Convo/shared/repositories/firebase_firestore.dart';
...
import 'package:Convo/shared/widgets/bottom_inset.dart';
import 'package:Convo/theme/color_theme.dart';
                ...
                SliverToBoxAdapter(
                  child: Center(
                    child: Container(
                      ...
                      child: Text(
                        '🔒Messages and calls are end-to-end encrypted. No one outside this chat, not even Convo, can read or listen to them.',
                        style: TextStyle(
                          fontSize: 13,
                          color: isDarkTheme
