...
import 'package:Convo/features/chat/models/attachement.dart';
import 'package:Convo/features/chat/models/message.dart';
import 'package:Convo/features/chat/models/recent_chat.dart';
...
import 'package:Convo/shared/repositories/download_service.dart';
import 'package:Convo/shared/repositories/firebase_firestore.dart';
import 'package:Convo/features/home/views/contacts.dart';
import 'package:Convo/shared/models/user.dart';
import 'package:Convo/shared/repositories/isar_db.dart';
import 'package:Convo/shared/repositories/push_notifications.dart';
  ...
  void initState() {
    ...
    _floatingButtons = [
      ...
      Column(
        ...
        children: [
          FloatingActionButton(
            backgroundColor: const Color.fromARGB(255, 217, 31, 31),
            onPressed: () {},
...
class HomePageContactsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: IsarDb.getConvoContacts(),
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          return Container();
        }
        ...
        if (userCount > 3) {
          ...
          descriptionList[1] = ' and ${users[2]} are on Convo';
        } else if (userCount > 1) {
          descriptionList[0] = users.join(' and ');
          descriptionList[1] = ' are on Convo';
        } else {
          descriptionList[0] = '${users.first}';
          descriptionList[1] = ' is one Convo.';
        }
